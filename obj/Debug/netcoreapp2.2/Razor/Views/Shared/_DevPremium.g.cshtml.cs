#pragma checksum "/home/zubu/Documents/noresume/Views/Shared/_DevPremium.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a446a82dff2e48317570680d9ebb83f81fa6ad55"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a446a82dff2e48317570680d9ebb83f81fa6ad55", @"/Views/Shared/_DevPremium.cshtml")]
    ...
    public class Views_Shared__DevPremium : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            BeginContext(0, 34851, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a446a82dff2e48317570680d9ebb83f81fa6ad553835", async() => {
                BeginContext(35, 5, true);
                WriteLiteral("\n    ");
                EndContext();
                BeginContext(40, 59, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a446a82dff2e48317570680d9ebb83f81fa6ad554218", async() => {
                }
                );
...
#line 4 "/home/zubu/Documents/noresume/Views/Shared/_DevPremium.cshtml"
                  Write(Html.Raw(Json.Serialize(Model)));

#line default
#line hidden
                EndContext();
                BeginContext(168, 14307, true);
                WriteLiteral(@";
     ...
     ");
                WriteLiteral(@"   var minKeySubmissionRank = 0;
        ...
        $(document).ready(function() {        
            var githubUname = devModel.workingProfile.githubUsername;
                                
            try {
              if (githubUname !== '') {
                  requestToGH1 = $.get('http://api.github.com/users/' + githubUname, function(userInformation, userStatus) {
                      if (userStatus === ""success"") {
                          gitHubShortProfile = userInformation;

                          // Card Initiator
   ");
                WriteLiteral(@"                       $(""#_githubAvatar"").attr(""src"", gitHubShortProfile.avatar_url);
    ...
    ");
                WriteLiteral(@"                      $(""#_gitHubDevURL"").attr(""href"", gitHubShortProfile.html_url);
                          ...
                          // Repository Findings
                          request");
                WriteLiteral(@"ToGH2 = $.get(gitHubApiURL + githubUsername + '/repos?page=1&per_page=10&sort=updated', function(repositories, status) {
  ...
  ");
        ...
        function CodeForcesDataProcessor(data) {
            ...
            for (var i = data.result.length - 1; i >= 0; i--) {
                ...
                if (cf_problems_attempt_solved[problemId] === undefined) {
                    cf_proble");
                WriteLiteral(@"ms_attempt_solved[problemId] = {
                        attempts: 1,
                        solved: 0
                    };
                } else {
                ...
                WriteLiteral(@"@1 because
                    ...
                    if (cf_attempt_rating_quality[submission.problem.rating] === undefine");
                WriteLiteral(@"d) {
        ...
        function sortProperties(obj) {
            ...
            for (var key in obj)
                ...
                WriteLiteral(@"// each item is an array in format [key, value]
        ...
        function CodeForcesEffortSummary() {
            ...
            var m");
                WriteLiteral(@"aximumProblemBeenAttempted = '';
            ...
            for (var submissions in cf_problems_attempt_solved) {
                ...
                if (cf_problems_attempt_solved[submissions].attempts > maximumAttemptsBeforeSolvingAProblem) {
                    ...
                    maximumProblemBeenAttempted = submi");
                WriteLiteral(@"ssions;
                }
      ...
      ");
                WriteLiteral(@"      $('#DevAcceptedAtFirstTry').text(OneSubmissionTry);
        }
        ...
        function incrementLang");
                WriteLiteral(@"uages(languageNumber) {
            if (languageNumber === 1) {
                uvaLanguages[""ANSI_C""]++;
        ...
        function regressi");
                WriteLiteral(@"onDatasetTableConstructor() {
   ...
   ");
        ...
        function wordCounter() {
            $('.count').each(function() {
                $");
                WriteLiteral(@"(this).prop('Counter', 0).animate({
                    Counter: $(this).text()
                }, {
                    duration: 8000,
                    easing: 'swing',
        ...
        function _demonstrateLanguagesGitHub(gitHubLang");
                WriteLiteral(@"uageChart, chartType, titleText) {
            var tempLang = {};
