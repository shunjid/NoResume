#pragma checksum "E:\NoResume\Views\Shared\_DevPremium.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "10c577fc04d648bcdc2be713bc98eeed999cd00e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"10c577fc04d648bcdc2be713bc98eeed999cd00e", @"/Views/Shared/_DevPremium.cshtml")]
    ...
    public class Views_Shared__DevPremium : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            BeginContext(0, 28381, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("environment", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "10c577fc04d648bcdc2be713bc98eeed999cd00e3305", async() => {
                BeginContext(38, 55, true);
                WriteLiteral("\r\n\t<script type = \"text/javascript\" >\r\n\tvar devModel = ");
                EndContext();
                BeginContext(94, 21, false);
#line 3 "E:\NoResume\Views\Shared\_DevPremium.cshtml"
              Write(Json.Serialize(Model));

#line default
#line hidden
                EndContext();
                BeginContext(115, 14435, true);
                WriteLiteral(@";
...
$(document).ready(function () {
	...
	cf_handle = devModel.workingProfile.codef");
                WriteLiteral(@"orcesUsername;
		...
		if (githubUsername != null) {
			requestToGH1 = $.get(gitHubApiURL + githubUsername, function (userInformation, userStatus) {
				if (userStatus === ""success"") {
					...
					i");
                WriteLiteral(@"f (gitHubShortProfile.bio === null || gitHubShortProfile.bio === """") {
					...
					$('#_githubDevLastActive').text(days_between(new Date(gitHubShortProfile.updated_at");
                WriteLiteral(@"), new Date()) + ' Days ago');
	...
	try {
		if (uvaHandle != null) {
			...
			request");
                WriteLiteral(@"ToUhunt = $.get(uva_api_url + 'uname2uid/' + uvaHandle, function (data, status) {
				/*
					...
					requestToUhunt2 = $.get(uva_api_url + 'subs-user/' + data, function (Submission, SubmissionStatus) {
						...
						if (uvaAllSubmissions.length < 1) {
							...
							requestToUhunt3 = $.get(uva_api_url + 'ranklist/' + data + '/1/1', function (ranksInfo, StatusRank) {
								...
								requestToUHunt5 = $.get(u");
                WriteLiteral(@"va_api_url + 'subs-user/' + ranksInfo[2].userid, function (SubmissionBelow, StatusBelow) {
		...
		requestToGH3 = $.get(repositories[i].languages_url, function (languages, status) {
			...
			for (var k = 0; k < tempKeys.length; k++) {
				if (languagesOfRepositories[tempKeys[k]] === undefined) {
					...
					languages");
                WriteLiteral(@"OfRepositories[tempKeys[k]] += languages[tempKeys[k]];
				}
...
<!--  Codeforces");
                WriteLiteral(@" functions initiates  -->
...
function CodeForcesDataProcessor(data) {
	...
	for (var i = data.result.length - 1; i >= 0; i--) {
		...
		if (submission.verdict === 'OK' && cf_problem");
                WriteLiteral("s_attempt_solved[problemId].solved === 1) {\r\n\t\t\t/*\r\n\t\t\t ** Counting Tags\r\n\t\t\t ** solved is counted ");
                EndContext();
                BeginContext(14551, 13816, true);
...
function CodeForcesEffortSummary() {
	...
	va");
                WriteLiteral(@"r numberOfProblemsSolved = 0;
	...
	for (var submissions in cf_problems_attempt_solved) {
		...
		if (cf_problems_attempt_solved[submissions].solved > maximumNumberAProblem");
...
function UvaSubmissionProcessor(data) {
	...
	$('#_uvaTotalSubmissions').tex");
                WriteLiteral(@"t(data.length);
...
fu");
                WriteLiteral(@"nction incrementLanguages(languageNumber) {
	if (languageNumber === 1) {
		uvaLanguages[""ANSI_C""]++;
...
function UVARankingProcessor(ranksInfo) {
	...
	rankingInfo");
                WriteLiteral(@"[""rankingOfBelowOfQueried""] = ranksInfo[2].rank;
...
function regressionDatasetTableConstructor() {
	...
	x.innerHTML = regressionDataAr");
                WriteLiteral(@"ray[0].ranking;
